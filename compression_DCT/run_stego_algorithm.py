...
NUM_CHANNELS = 3
COVER_IMAGE_FILEPATH  = "../pictures/lion_king.png" # Choose your cover image (PNG)
STEGO_IMAGE_FILEPATH  = "../pictures/lion_king_e.png"
...
#WE PUT THE RED, GREEN AND BLUE VALUES FOR OUR PICTURE IN THE cover_image_YCC channels
